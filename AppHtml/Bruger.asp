...
<body>
    ...
    <form action="none" name="User_form" autocomplete="off" vdfControlType="form" vdfControlName="User_form" vdfMainTable="User" vdfServerTable="User" vdfWebObject="oBruger">
        <!-- Status fields -->
                        ...
                        <table class="EntryTable">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input class="LookupButton" type="button" title="List of all records" tabindex="-1" vdfControlType="lookupdialog" vdfWebObject="oBruger" vdfLookupTable="User" vdfLookupFields="user__userid, user__loginname" />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input class="LookupButton" type="button" title="List of all records" tabindex="-1" vdfControlType="lookupdialog" vdfWebObject="oBruger" vdfLookupTable="User" vdfLookupFields="user__loginname" />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input class="LookupButton" type="button" title="List of all records" tabindex="-1" vdfControlType="lookupdialog" vdfWebObject="oBruger" vdfLookupTable="User" vdfLookupFields="user__firstname, user__lastname" />
                                </td>
                            </tr>
                            <tr>
